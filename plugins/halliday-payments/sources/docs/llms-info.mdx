...
For users developing with [Claude Code](https://claude.com/product/claude-code), Halliday payments now has an official plugin available to automate tedious tasks of development.
...
- **Check my integration** — Scan your codebase against an integration checklist and flag only the items that could cause issues with the Halliday payments integration.
- **Look up a payment** — Fetch a payment by ID, show a clear status summary with explanation, and give status-specific next steps.

The Halliday Claude Code plugin will be available in the [Anthropic community marketplace](https://github.com/anthropics/claude-plugins-community) soon. For now, the plugin can be utilized in development mode using git and these commands:
...
paths:
      ...
      parameters:
        ...
        - name: features[]
          ...
          schema:
            ...
            items:
              type: string
              enum: [BETA_EDGES, ORG_BETA_EDGES, ORG_EDGES]
      responses:
        "200":
            ...
            schema:
              oneOf:
                ...
                - title: ContinueConfirmPaymentRequest
                  description: |
                    Continuation request after a USER_VERIFY instruction. Submit the signed verification
  ...
  /orgs/webhooks:
    ...
    get:
      ...
      description: |
        List the webhooks registered for your org. The signing secret is never included in this response.
  ...
  schemas:
    ...
    ChainInfo:
      ...
      properties:
        ...
        address_family:
          ...
          enum: [EVM, SOL, BTC, TON, TRON, ALEO, DOGE, LTC, XRPL]
          example: EVM
        native_currency:
          type: object
          properties:
    ...
    QuoteRequest:
      ...
      properties:
        ...
        onramp_methods:
          ...
          items:
            type: string
            enum: [CREDIT_CARD, DEBIT_CARD, ACH, FIAT_BALANCE, TOKEN_BALANCE, APPLE_PAY, PAYPAL, VENMO, REVOLUT, GOOGLE_PAY, SEPA, FASTER_PAYMENTS, PIX, UPI, WIRE]
    ...
    RequestForPaymentBalances:
      ...
      properties:
        ...
        near_queries:
          type: array
          description: Near wallet and token combinations to query.
          items:
            type: object
            required:
              - address
            ...
            properties:
              address:
                type: string
                description: Near wallet address to query.
              token:
                $ref: "#/components/schemas/Token"
                description: Token identifier to query at the wallet address.
    ...
    WithdrawPaymentRequest:
      ...
      properties:
        ...
        withdraw_account:
          ...
          enum: [INTENT, SPW]
          default: SPW
          description: Type of account to withdraw from. Use the account value from the balance result.
        payload:
          type: string
          description: The withdraw_authorization string returned from the POST /payments/withdraw response.
    ...
    PaymentStatus:
      ...
      properties:
        ...
        status:
          type: string
          enum: [PENDING, COMPLETE, FAILED, EXPIRED, WITHDRAWN, TAINTED, UNCONFIRMED]
        funded:
          type: boolean
    ...
    AmountIssue:
      ...
      properties:
        ...
        reason:
          type: string
          enum: [TOO_LOW, TOO_HIGH, NO_VALID_AMOUNT, UNKNOWN]
    ...
    PieceInfo:
      ...
      properties:
        type:
          type: string
          enum: [user_fund, onramp, poll, bridge, rev_share, transfer_out, convert, custom_call]
    ...
    ChangeAmount:
      ...
      properties:
        account:
          type: string
          enum: [USER, DEST, HALLIDAY, SPW, REV_SHARE, BRIDGE]
        resource:
    ...
    Resource:
      ...
      properties:
        ...
        property:
          type: string
          enum: [APPROVAL, BALANCE, SIDE_EFFECT]
    ...
    ValidationErrorResponse:
      type: object
      description: |
        Returned when a request body fails schema validation. `errors` contains one entry per
        validation issue.
      required:
        - errors
      properties:
    ...
    WebhookSummary:
      ...
      properties:
        ...
        auth_header_name:
          type: [string, "null"]
          description: |
            Name of the custom delivery auth header, if one is configured (the value is never returned).
    ...
    RotateSecretRequest:
      ...
      properties:
        ...
        retire_after:
          ...
          format: date-time
          description: |
            Optional. When the previous signing secret(s) should stop signing. Floored to at least 24h
...
tags:
  ...
  - name: Webhooks
    description: |
      Register HTTPS endpoints to receive signed notifications when a workflow reaches a terminal
