...
Halliday Payments provides a non-custodial blockchain payment network, which is immutable and completely verifiable onchain. 
...
Halliday's smart contract infrastructure has been independently reviewed by leading security firms, including [ChainSecurity](https://www.chainsecurity.com/), [Zellic](https://www.zellic.io/), and [Halborn](https://www.zellic.io/). Audit findings are reviewed, prioritized, and remediated before production deployment.
